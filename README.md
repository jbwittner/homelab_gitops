...
| **onyxia** | Kubernetes, ingress Traefik | **GitOps** via son **propre Argo CD** (hub autonome). Push sur `main` → Argo reconcilie. Socle ingress + TLS. | [`onyxia/README.md`](onyxia/README.md) |
